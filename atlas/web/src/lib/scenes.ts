...
export const SCENES: Scene[] = [
  ...
  { id: "path", title: "One path", body: "ASML enables TSMC, which fabricates NVIDIA, which powers Microsoft.",
    highlightPath: [["asml", "tsmc"], ["tsmc", "nvidia"], ["nvidia", "microsoft"]] },
  ...
  { id: "forgotten", title: "Forgotten plays", body: "Power, cooling, networking — the under-followed edges of the chain.", focusStage: "power" },
