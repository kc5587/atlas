...
The repository is being rebuilt from an empty starting point. The first
checkpoint contains the immutable graph foundation. The next slice adds typed
observations, provenance, and a regional bottleneck score using fixture data.
